(function(){
	...
	class Commander {
		...
		*/
		 ...
		 * @param {function|string} callbackSuccess [callback after confirmation success]
		 * @param {function|string} callbackFailure [callback after confirmation failure]
		 */
        confirm(message, callbackSuccess, callbackFailure = null)
        {
        	let conf = confirm(message);
        	if (conf) {
                if(is_string(callbackSuccess)){
	...
	function init()
	{
		$(".command").on('change click submit keyup', function(e){
